...
public class MovementServiceImpl implements MovementServicePort {
    ...
    public Movement addMovement(Movement movement) {
        ...
        if (!movementPersistencePort.hasMovementInReferenceDeclared(movement.getGoods().getReference())) throw new RuntimeException("Invalid Goods Reference - You cannot declare an exit for a goods reference for which an entry has not been declared.");
